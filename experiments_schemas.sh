hatch run python scripts/launcher.py --normalize True --T 1 --phi zerobond --nsteps 48 --nsims 500 --nepochs 500 --sigma 0.01 --schema 1 --wandb True
hatch run python scripts/launcher.py --normalize True --T 1 --phi zerobond --nsteps 48 --nsims 1000 --nepochs 500 --sigma 0.01 --schema 1 --wandb True
hatch run python scripts/launcher.py --normalize True --T 1 --phi zerobond --nsteps 48 --nsims 1500 --nepochs 500 --sigma 0.01 --schema 1 --wandb True
hatch run python scripts/launcher.py --normalize True --T 1 --phi zerobond --nsteps 48 --nsims 5000 --nepochs 500 --sigma 0.01 --schema 1 --wandb True
# hatch run python scripts/launcher.py --normalize True --T 2 --phi zerobond --nsteps 48 --nepochs 500 --sigma 0.01 --schema 1 --wandb True --save True
# hatch run python scripts/launcher.py --normalize True --T 3 --phi zerobond --nsteps 48 --nepochs 500 --sigma 0.01 --schema 1 --wandb True --save True
